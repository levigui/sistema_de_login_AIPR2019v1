<?php
require_once 'configDB.php';//Conexão com o Bnaco de dados
            ...
            <div class="col-lg-5 mt-5">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="csenha" id="csenha" class="form-control" placeholder="******" required>
                    </div>
                    <div class="form-group">
                        <input type="submit" value=":: Gerar nova senha ::" name="criar" class="btn - btn-block" style=" box-shadow:5px 5px 8px black;  background:darkgreen; color:white;" >
                    </div>
                </form>
            </div>
        </section>
