...
<head>
    ...
    <title>Sistema de Login PNG leviGui Systems v_v FullMoonBack </title>
    <style>
        #caixaCadastro,
        #caixaRecuperarSenha,
        #alerta {
        ...
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaCadastro">
                ...
                <form action="#" class="p-2" id="formCadastro">
                    ...
                    <div class="form-group">
                        <input type="text" name="nomeCompleto" id="nomeCompleto" class="form-control" placeholder="Nome completo" minlength="6" required>
                    </div>
