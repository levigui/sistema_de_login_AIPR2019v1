...
<body class="bg-dark">
    ...
    <div class=" mt-4 container ">
        <div class="row">
            <div class="col-9 border border-info bg-info mb-5">
                <h1 class="text-light  mt-4  font-weight-bolder text-center mb-5 ">Perfil do <?= $usuario ?></h1>
            </div>
            <div class="col-4 border border-info   "> <img src="<?= $imagemUsuario ?>" alt="Avatar" width="250" height="200"></div>
            <div class="col-6 border border-info  text-monospace bg-info">
